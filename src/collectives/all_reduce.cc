...
ncclResult_t ncclAllReduce(const void* sendbuff, void* recvbuff, size_t count,
  ...
  void** compressedbuff_ptr1 = &compressedbuff1;
  ...
  struct ncclInfo info = { ncclCollAllReduce, "AllReduce",
    sendbuff, recvbuff, tempbuff1, tempbuff2, (const void*)compressedbuff1, compressedbuff2, count, datatype, op, 0, comm, stream, /* Args */
